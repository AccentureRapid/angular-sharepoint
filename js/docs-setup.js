  ...
  "pages": [
    {
      "section": "api",
      "id": "index",
      "shortName": "angular-sharepoint API",
      "type": "overview",
      "moduleName": "angular-sharepoint API",
      "shortDescription": "angular-sharepoint API",
      "keywords": "angular-sharepoint api overview"
    },
    {
      "section": "api",
      "id": "ExpertsInside.SharePoint",
      "shortName": "ExpertsInside.SharePoint",
      "type": "overview",
    ...
    {
      "section": "api",
      "id": "ExpertsInside.SharePoint.Core",
      "shortName": "ExpertsInside.SharePoint.Core",
      "type": "overview",
      "moduleName": "ExpertsInside.SharePoint.Core",
      "shortDescription": "ExpertsInside.SharePoint.Core",
      "keywords": "api core expertsinside module modules overview services sharepoint utility"
    },
    {
      "section": "api",
      "id": "ExpertsInside.SharePoint.Core.$spConvert",
      "shortName": "ExpertsInside.SharePoint.Core.$spConvert",
      "type": "object",
      "moduleName": "ExpertsInside.SharePoint.Core",
    ...
    {
      "section": "api",
      "id": "ExpertsInside.SharePoint.Core.$spPageContextInfo",
      "shortName": "ExpertsInside.SharePoint.Core.$spPageContextInfo",
      "type": "object",
      "moduleName": "ExpertsInside.SharePoint.Core",
    ...
    {
      "section": "api",
      "id": "ExpertsInside.SharePoint.Core.$spRest",
      "shortName": "ExpertsInside.SharePoint.Core.$spRest",
      "type": "service",
      "moduleName": "ExpertsInside.SharePoint.Core",
    ...
    {
      "section": "api",
      "id": "ExpertsInside.SharePoint.List",
      "shortName": "ExpertsInside.SharePoint.List",
      "type": "overview",
      "moduleName": "ExpertsInside.SharePoint.List",
      "shortDescription": "ExpertsInside.SharePoint.List",
      "keywords": "$splist api core expertsinside list module overview rest service sharepoint wrapper"
    },
    {
      "section": "api",
      "id": "ExpertsInside.SharePoint.List.$spList",
      "shortName": "ExpertsInside.SharePoint.List.$spList",
      "type": "service",
      "moduleName": "ExpertsInside.SharePoint.List",
    ...
    {
      "section": "api",
      "id": "ExpertsInside.SharePoint.Search",
      "shortName": "ExpertsInside.SharePoint.Search",
      "type": "overview",
      "moduleName": "ExpertsInside.SharePoint.Search",
      "shortDescription": "ExpertsInside.SharePoint.Search",
      "keywords": "$spsearch api core expertsinside include js module overview rest search service sharepoint wrapper"
    },
    {
      "section": "api",
      "id": "ExpertsInside.SharePoint.Search.$spSearch",
      "shortName": "ExpertsInside.SharePoint.Search.$spSearch",
      "type": "service",
      "moduleName": "ExpertsInside.SharePoint.Search",
    ...
    {
      "section": "api",
      "id": "ExpertsInside.SharePoint.User",
      "shortName": "ExpertsInside.SharePoint.User",
      "type": "overview",
      "moduleName": "ExpertsInside.SharePoint.User",
      "shortDescription": "ExpertsInside.SharePoint.User",
      "keywords": "$spuser api core expertsinside include js module overview profiles rest service sharepoint user userprofiles wrapper"
    },
    {
      "section": "api",
      "id": "ExpertsInside.SharePoint.User.$spUser",
      "shortName": "ExpertsInside.SharePoint.User.$spUser",
      "type": "service",
      "moduleName": "ExpertsInside.SharePoint.User",
